export default function ScreenshotCirclesListEn() {
      ...
      <div style={{
        ...
        <div style={{ background: "linear-gradient(160deg, #0d7a55 0%, #18a574 55%, #22c98a 100%)", flexShrink: 0 }}>
          ...
          <div style={{ padding: "10px 18px 0", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              <div style={{ fontSize: 28, fontWeight: 800, color: "#fff", letterSpacing: -0.5 }}>My Circles</div>
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.7)", marginTop: 1 }}>8 circles · 54 members</div>
            </div>
          ...
          <div style={{ display: "flex", gap: 8, padding: "12px 16px 16px" }}>
            {([["7 Active", "rgba(255,255,255,0.18)"], ["$8,450 Collected", "rgba(240,165,0,0.3)"], ["54 Members", "rgba(255,255,255,0.12)"]] as [string,string][]).map(([label, bg2], i) => (
        ...
        <div style={{ background: card, borderTop: `1px solid ${border}`, display: "flex", paddingBottom: 28, paddingTop: 10, flexShrink: 0 }}>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 3 }}>
            ...
            <span style={{ fontSize: 9, fontWeight: 700, color: primary }}>Circles</span>
          </div>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 3 }}>
            ...
            <span style={{ fontSize: 9, color: muted }}>Settings</span>
          </div>
        </div>
      </div>
