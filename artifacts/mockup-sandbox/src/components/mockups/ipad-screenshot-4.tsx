export default function IPadScreenshot4() {
  ...
  const circles = [
    ...
    { name: "Neighbors Circle", freq: "Monthly", active: true, cycle: 2, total: 8, amount: 300 },
  ];
    ...
    <div style={{
      ...
      <div style={{ textAlign: "center", color: "#fff", zIndex: 1, padding: "0 120px" }}>
        ...
        <div style={{ fontSize: 52, color: "rgba(255,255,255,0.55)", fontWeight: 400 }}>
          Manage every savings circle effortlessly
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ padding: "16px 60px 14px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontSize: 70, fontWeight: 700, color: text }}>My Circles</span>
          ...
          {circles.map((c, i) => (
            <div key={i} style={{ background: card, borderRadius: 36, padding: "32px 40px", marginBottom: 24, border: `1px solid ${border}` }}>
              ...
              <div style={{ display: "flex", gap: 28, marginTop: 14 }}>
                ...
                <span style={{ fontSize: 30, color: muted }}>Cycle {c.cycle}/{c.total}</span>
              </div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <span style={{ fontSize: 28, color: muted }}>Cycle {c.cycle} of {c.total} ›</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{ background: card, borderTop: `1px solid ${border}`, display: "flex", paddingBottom: 50 }}>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 24, gap: 8 }}>
            ...
            <span style={{ fontSize: 26, fontWeight: 700, color: primary }}>Circles</span>
          </div>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 24, gap: 8 }}>
            ...
            <span style={{ fontSize: 26, color: muted }}>Settings</span>
          </div>
        </div>
      </div>
    </div>
