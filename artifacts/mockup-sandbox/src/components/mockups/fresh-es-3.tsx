export default function FreshEs3() {
  ...
  const members = [
    { name: "María García", initials: "MG", turn: 1, rating: 5, note: "Siempre puntual", paid: true },
    { name: "José López", initials: "JL", turn: 2, rating: 4, note: "Buen pagador", paid: false },
    { name: "Ana Martínez", initials: "AM", turn: 3, rating: 3, note: "", paid: false },
    { name: "Carlos Ruiz", initials: "CR", turn: 4, rating: 5, note: "Muy confiable", paid: true },
    { name: "Laura Torres", initials: "LT", turn: 5, rating: 4, note: "", paid: true },
    { name: "Pedro Sánchez", initials: "PS", turn: 6, rating: 5, note: "Excelente historial", paid: false },
    { name: "Rosa Herrera", initials: "RH", turn: 7, rating: 4, note: "", paid: true },
    { name: "Miguel Ángel", initials: "MÁ", turn: 8, rating: 2, note: "Pago tardío", paid: false },
    { name: "Sofía Ramírez", initials: "SR", turn: 9, rating: 5, note: "", paid: true },
    ...
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", background: bg, fontFamily: "-apple-system,'SF Pro Display','Helvetica Neue',sans-serif", display: "flex", flexDirection: "column" }}>
      <div style={{ background: "linear-gradient(160deg,#0d7a55 0%,#18a574 55%,#22c98a 100%)", flexShrink: 0 }}>
        ...
        <div style={{ padding: "10px 20px 16px", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 20, fontWeight: 800, color: "#fff" }}>Tanda Navidad 2025</div>
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.75)" }}>10 integrantes · Turno 3/12</div>
          </div>
        </div>
      </div>
      <div style={{ background: card, display: "flex", borderBottom: `2px solid ${border}`, flexShrink: 0 }}>
        <div style={{ flex: 1, padding: "13px 0", textAlign: "center", color: muted, fontSize: 15 }}>Resumen</div>
        <div style={{ flex: 1, padding: "13px 0", textAlign: "center", borderBottom: `2.5px solid ${primary}`, color: primary, fontSize: 15, fontWeight: 700 }}>Calificaciones</div>
      </div>
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(to top,rgba(4,18,10,0.93) 0%,rgba(4,18,10,0.75) 50%,transparent 100%)", padding: "110px 32px 52px", textAlign: "center" }}>
        <div style={{ fontSize: 48, fontWeight: 900, color: "#fff", letterSpacing: -1, lineHeight: 1.1 }}>Califica a tus<br/>integrantes</div>
        <div style={{ fontSize: 20, color: "rgba(255,255,255,0.65)", marginTop: 10, fontWeight: 500 }}>Historial de confianza para cada miembro</div>
      </div>
    </div>
  );
}
