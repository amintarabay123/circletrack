    ...
    <div style={{
      ...
      <div style={{ textAlign: "center", color: "#fff", zIndex: 1, padding: "0 120px" }}>
        ...
        <div style={{ fontSize: 52, color: "rgba(255,255,255,0.55)", fontWeight: 400 }}>
          Real-time dashboard for every cycle
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ padding: "10px 48px 10px", display: "flex", alignItems: "center" }}>
          ...
          <div style={{ flex: 1, marginLeft: 24 }}>
            <div style={{ fontSize: 44, fontWeight: 700, color: text }}>Christmas Circle 2025</div>
            <div style={{ fontSize: 28, color: muted }}>Monthly · Cycle 3 of 12</div>
          </div>
        </div>

        {/* Tabs */}
        <div style={{ display: "flex", borderBottom: `2px solid ${border}`, marginLeft: 48, marginRight: 48 }}>
          <div style={{ padding: "20px 36px", borderBottom: `4px solid ${primary}`, color: primary, fontSize: 34, fontWeight: 600 }}>Summary</div>
          <div style={{ padding: "20px 36px", color: muted, fontSize: 34 }}>Members</div>
        </div>
        ...
        <div style={{ padding: "24px 48px" }}>
          <div style={{ display: "flex", gap: 20, marginBottom: 20 }}>
            <div style={{ flex: 1, background: card, borderRadius: 28, padding: "28px 32px", border: `1px solid ${border}`, textAlign: "center" }}>
              ...
              <div style={{ fontSize: 24, color: muted, marginTop: 6 }}>Pot this cycle</div>
            </div>
            <div style={{ flex: 1, background: card, borderRadius: 28, padding: "28px 32px", border: `1px solid ${border}`, textAlign: "center" }}>
              <div style={{ fontSize: 54, fontWeight: 700, color: success }}>75%</div>
              <div style={{ fontSize: 24, color: muted, marginTop: 6 }}>Collection rate</div>
            </div>
          </div>

          <div style={{ display: "flex", gap: 20, marginBottom: 24 }}>
            {([["3", "Paid", success], ["2", "Pending", muted], ["1", "Late", danger]] as [string, string, string][]).map(([v, l, c], i) => (
          ...
          <div style={{ display: "flex", alignItems: "center", background: primary + "12", borderRadius: 28, padding: "24px 32px", marginBottom: 24, border: `1px solid ${primary}28` }}>
            ...
            <div>
              <div style={{ fontSize: 24, color: muted }}>Receives the pot</div>
              <div style={{ fontSize: 36, fontWeight: 600, color: primary }}>María García</div>
            </div>
          </div>

          <div style={{ fontSize: 26, fontWeight: 700, color: muted, textTransform: "uppercase", letterSpacing: "1px", marginBottom: 18 }}>Payment Status</div>
